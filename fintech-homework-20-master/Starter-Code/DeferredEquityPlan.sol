...
contract DeferredEquityPlan {
    ...
    //for testing of the progam logic 
    // uint fakenow = now;
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "It is too early to distribute shares.");
        require(distributed_shares < total_shares, "distributed_shares exceeds total shares.");
    ...
    //For testing of the program logic
